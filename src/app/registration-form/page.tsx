...
export default function RegistrationFormPage() {
  ...
  const handleDownloadPDF = () => {
    ...
    html2canvas(input, {
      ...
      pdf.save(`fiche-inscription-${clubInfo.name.toLowerCase().replace(/ /g, "-")}.pdf`);
  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6 bg-gray-100 dark:bg-gray-900">
      ...
      <div className="max-w-4xl mx-auto bg-white dark:bg-background p-4 sm:p-8 rounded-md shadow-lg">
        <div ref={formRef} className="text-black bg-white p-4">
          <header className="flex items-start justify-between border-b-2 border-black pb-4 mb-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-lg">Fiche d’inscription</p>
