...
export function PlayerPaymentHistoryClient({ memberName }: { memberName: string }) {
  ...
  const { loading, playerPayments, deletePlayerPayment, updatePlayerPayment } = context;
  ...
  const handleAddComplement = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    await updatePlayerPayment(selectedPayment.id, amount);
        ...
        <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Historique des cotisations mensuelles.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <p className="text-muted-foreground">Aucun historique de paiement trouvé pour ce joueur.</p>
                </CardContent>
            </Card>
        </div>
    )
                        ...
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                ...
                                <AlertDialogDescription>
                                    Cette action ne peut pas être annulée. Cela supprimera définitivement cette entrée de paiement.
                                </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
