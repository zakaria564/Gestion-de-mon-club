...
import { ArrowLeft, Banknote, Calendar as CalendarIcon, CheckCircle, Clock, XCircle, UserCheck, History, Download } from "lucide-react";
        ...
        <div ref={receiptRef} className="p-8 bg-white text-black min-h-[297mm]">
            ...
            <CardContent className="px-0 pt-6">
                <div className="grid md:grid-cols-2 gap-x-12 gap-y-6 p-6 border-2 border-black rounded-lg">
                    ...
                    <div className="flex items-center gap-4 text-xl border-t border-black pt-4 text-black">
                ...
                {formattedTransactions.length > 0 && (
                    <div className="mt-12">
                        <h3 className="text-2xl font-bold mb-6 flex items-center border-b-2 border-black pb-2 text-black"><History className="mr-3 h-7 w-7" />Historique des Paiements</h3>
