...
import { ArrowLeft, Cake, Edit, Trash2, Home, Shirt, Phone, Flag, Mail, MapPin, PlusCircle, X, VenetianMask, UserSquare, UserCheck, ExternalLink, FileText } from "lucide-react";
      ...
      <Card>
        ...
        <CardContent className="pt-6 grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3"><Home className="h-4 w-4 text-muted-foreground" /><Badge style={{ backgroundColor: categoryColors[player.category] }}>{player.category}</Badge></div>
